      ...
      <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 pb-10">
        {schools.map(({ id, name, address, city, image }) => (
          ...
          >
            ...
            <div className="px-4 py-3 sm:p-5 flex-grow flex flex-col font-(family-name:--font-roboto)">
            <p>{city}</p>
            ...
            <button className="w-full bg-[#4CAE4C] hover:bg-[#449d44] text-white py-3 font-medium transition-colors duration-200 text-sm sm:text-base">
              Apply Now
            </button>
          </div>
        ))}
